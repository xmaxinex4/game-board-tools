...
export function HexIcon(props: HexIconProps): React.ReactElement {
  ...
  return (
    <svg className={className || ""} height={height ? `${height}` : "250px"} width={width ? `${width}` : "250px"} fill={fill || "#000000"} xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0.0 0.0 168.65879265091863 168.21784776902888" stroke="none" strokeLinecap="square" strokeMiterlimit="10">
      <clipPath id="p.0">
